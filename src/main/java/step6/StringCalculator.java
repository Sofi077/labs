...
public class StringCalculator {
        ...
        if (!numbers.isEmpty()){
            ...
            try{
                if (negative_numb.size()==0) {
                    ...
                    throw new step6.NegativeNumberException("negativ number are not allowed");  //новий об'єкт винятку з повідомленням
                }
            } catch (step6.NegativeNumberException e)  //задаємо тип винятку
            {
    ...
    public static void main(String[] args) {
        ...
        step6.StringCalculator obj_1 = new step6.StringCalculator(); // створюємо об’єкт obj_1
